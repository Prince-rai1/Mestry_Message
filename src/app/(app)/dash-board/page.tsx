...
import { Copy, Link2, Loader2, MessageCircle, RefreshCcw, ShieldCheck } from "lucide-react";
  ...
  <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-gray-800 via-gray-900 to-black">
    ...
    <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-8 px-6 py-12">
      ...
      <div className="text-center">
        ...
        <div className="mt-5 inline-flex items-center rounded-full border border-blue-500/20 bg-blue-500/10 px-5 py-2">
        ...
        <div className="rounded-[32px] bg-zinc-900/80 p-8 backdrop-blur-xl">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div>
              ...
              <div className="mt-6 rounded-2xl border border-zinc-700 bg-zinc-800/70 px-5 py-4">
      ...
      <div className="rounded-[32px] border border-white/10 bg-white/5 p-px shadow-[0_20px_80px_rgba(0,0,0,.45)] backdrop-blur-xl">
        ...
        <div className="rounded-[32px] bg-zinc-900/80 p-8 backdrop-blur-xl">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex items-center gap-5 rounded-2xl border border-zinc-700 bg-zinc-800/70 px-6 py-5">
      ...
      <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between mt-9">
        ...
        <Button
          ...
          className="h-12 rounded-xl border-zinc-700 bg-zinc-900 text-white transition-all duration-300 hover:scale-105 hover:border-blue-500 hover:bg-zinc-800"
        >
      ...
      <div className="h-px w-full bg-linear-to-r from-transparent via-zinc-700 to-transparent" />      {/* Messages */}
      ...
      {messages.length > 0 ? (
        ...
        <div className="rounded-[32px] border border-dashed border-zinc-700 bg-white/5 p-12 backdrop-blur-xl">

          <div className="flex flex-col items-center justify-center text-center">

            <div className="rounded-full bg-linear-to-br from-violet-500/20 to-blue-500/20 p-8">

              <MessageCircle className="h-14 w-14 text-violet-400" />
            ...
            <p className="mt-3 max-w-lg text-zinc-400">
              ...
              Share your public profile link with your friends and start
